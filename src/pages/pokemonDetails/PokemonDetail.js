...
export default function PokemonDetail() {
    ...
    return (
        <div className="p-10">
            <NavLink to={`../..`} className=" block border w-full md:w-1/3 rounded-2xl px-6 py-2 bg-slate-600 text-white hover:bg-slate-500 transition duration-500">Retour</NavLink>
            <main className="container border rounded-2xl bg-white drop-shadow-lg m-auto mt-5 p-5">
